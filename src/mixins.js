    ...
    methods: {
        ...
        filterBySearch(val, data) {
            ...
            if(searchVal === '') {
                ...
                return data.filter(el => el.firstName.toLowerCase().includes(searchVal) || el.lastName.toLowerCase().includes(searchVal) || el.email.toLowerCase().includes(searchVal) || formatMixin.methods.formattedDate(el.paidOn).toLowerCase().includes(searchVal))
            }
        },
